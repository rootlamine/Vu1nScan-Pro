...
PORTS = {
    21:   {"service": "FTP",         "severity": "HIGH",     "cvss": 7.5,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", "cwe_id": "CWE-319",
    ...
    22:   {"service": "SSH",         "severity": "MEDIUM",   "cvss": 5.3,
           "cvss_vector": "AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:L/A:N", "cwe_id": "CWE-284",
    ...
    23:   {"service": "Telnet",      "severity": "CRITICAL", "cvss": 9.8,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:H", "cwe_id": "CWE-319",
    ...
    25:   {"service": "SMTP",        "severity": "MEDIUM",   "cvss": 5.3,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:L/I:N/A:N", "cwe_id": "CWE-284",
    ...
    8443: {"service": "HTTPS-Alt",   "severity": "LOW",      "cvss": 3.1,
           "cvss_vector": "AV:N/AC:H/PR:N/UI:N/S:U/C:L/I:N/A:N", "cwe_id": "CWE-284",
    ...
    4444: {"service": "Backdoor",    "severity": "CRITICAL", "cvss": 10.0,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:H", "cwe_id": "CWE-912",
           "desc": "Port 4444 ouvert — port classique de backdoor (Metasploit, etc.)."},
    5900: {"service": "VNC",         "severity": "HIGH",     "cvss": 8.8,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:H/A:N", "cwe_id": "CWE-284",
    ...
    11211:{"service": "Memcached",   "severity": "HIGH",     "cvss": 7.5,
           "cvss_vector": "AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N", "cwe_id": "CWE-284",
        ...
        try:
            ...
            for port in sorted(open_ports):
                ...
                vulns.append(self.vuln(
                    ...
                    evidence       = f"Port {port}/tcp ({info['service']}) répond sur {host}.",
                    recommendation = (
